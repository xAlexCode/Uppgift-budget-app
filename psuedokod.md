...
1. När en inkomst eller utgift sparas ska den visas i en lista på sidan 2 Loopa igenom arrayen och skapa en visuell post i DOM för varje objekt med beskrivninv, belopp, kategori, typ(inkomst/utgift) och en radera knapp 3 Varje post ska också ha en dropdown‑lista (select) där användaren kan ändra kategori 4 När en kategori ändras eller en post raderas ska det loopas igenom arrayen igen så det uppdateras igen
